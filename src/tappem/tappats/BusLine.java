...
public class BusLine implements Comparable<BusLine>{
	...
	public int compareTo(BusLine arg0) {
		BusLine o =  arg0;
		...
		if(e.equals(MargueriteTransportation.noMoreBuses))
			...
			{
				Log.d("TAPPATS", "BusLine compare to other  " + e + " " + o.getLineName());
				return 1;
			}
		}
		if(estimatedDepartureTime.equals(MargueriteTransportation.noMoreBuses))
			...
			try{
				...
				{
					Log.d("TAPPATS", "BusLine compare to me " + estimatedDepartureTime + "  " + lineName);
					return 0;
				}
		}
